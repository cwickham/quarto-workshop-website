...
footer: "[andrew.quarto.pub/alaska-asa](https://andrew.quarto.pub/alaska-asa)"
format:
  revealjs:
    author:
      - "Andrew Bray"
...
-   Follow the instructions in the document for how to modify it, then exchange one new thing you've learned with your neighbor.
:::
...
-   Share your favorite trick with your neighbor.
:::
