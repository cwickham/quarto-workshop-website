---
title: "Hello Quarto"
subtitle: "Dynamic Documents: Quarto for R, Julia, and Python"
institute: "RT2 UC Berkeley "
author: "Andrew Bray"
...
<https://andrew.quarto.pub/rt2-quarto/pre-work.html>
:::
...
-   Download and open the exercises for this session:

    ```{r}
    #| eval: false

    usethis::use_course("https://tinyurl.com/quarto-rt2")
```
:::
