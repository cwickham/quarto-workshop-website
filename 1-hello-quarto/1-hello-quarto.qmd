...
footer: "[andrew.quarto.pub/boston-asa](https://andrew.quarto.pub/boston-asa)"
format:
  revealjs:
    author:
      - "Andrew Bray"
...
Lecture segments + live coding
  ...
  - Please use Zoom Reactions > Raise Hand if you have a question
    Alt+Y on PC, Opt+Y on MC
...
## Eight hours on zoom! {.smaller}

:::{.columns}

:::{.column width="50%"}

![](https://media.giphy.com/media/7sThmP82L5v20/giphy.gif)
...
1. 20 min breaks every hour. Turn off camera and leave your desk.
2. Take longer breaks if needed (after first two sections).
3. Contribute to the [Spotify collaborative playlist](https://open.spotify.com/playlist/4roDs3a42G8muTHAnp4oNw?si=8a348cdbcc534846&pt=8a56da71853831951873a78430048e91) (played during breaks). You'll need a Spotify account.
...
![](https://i.gifer.com/A7YM.gif){fig-align="center"}
...
```{r}
#| echo: false
countdown::countdown(15, font_size = "8rem")
```
